...
table[0xFF00] =  chr(10) #'\\n' newline.
table[0xFF01] =  chr(10) #'\\n' newline. Usado para indicar FIN DE NOMBRE DE PERSONAJE.  En texto común, intercambiable con 0xFF00 sino
...
def readROMregion(addr_from, addr_to, ROMpath = r"..\roms\Magical Starsign\0845 - Magical Starsign (Europe) (En,Fr,De,Es,It).nds"):
